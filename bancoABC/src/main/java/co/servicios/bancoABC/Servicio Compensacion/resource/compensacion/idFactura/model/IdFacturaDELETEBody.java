...
public class IdFacturaDELETEBody {
     ...
     * @param valorFactura
     */
    public IdFacturaDELETEBody(Double valorFactura) {
        super();
    ...
    public IdFacturaDELETEBody withValorFactura(Double valorFactura) {
        this.valorFactura = valorFactura;
        return this;
    }
    ...
    public IdFacturaDELETEBody withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(IdFacturaDELETEBody.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof IdFacturaDELETEBody) == false) {
            return false;
        }
        IdFacturaDELETEBody rhs = ((IdFacturaDELETEBody) other);
