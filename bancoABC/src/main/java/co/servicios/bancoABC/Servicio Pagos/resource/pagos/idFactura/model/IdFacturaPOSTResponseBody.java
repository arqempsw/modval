...
public class IdFacturaPOSTResponseBody {
     ...
     * 
     */
    public IdFacturaPOSTResponseBody() {
    }
     ...
     * @param idFactura
     */
    public IdFacturaPOSTResponseBody(Double idFactura, String mensajeOK) {
        super();
    ...
    public IdFacturaPOSTResponseBody withIdFactura(Double idFactura) {
        this.idFactura = idFactura;
        return this;
    }
    ...
    public IdFacturaPOSTResponseBody withMensajeOK(String mensajeOK) {
        this.mensajeOK = mensajeOK;
        return this;
    }
    ...
    public IdFacturaPOSTResponseBody withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(IdFacturaPOSTResponseBody.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("idFactura");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof IdFacturaPOSTResponseBody) == false) {
            return false;
        }
        IdFacturaPOSTResponseBody rhs = ((IdFacturaPOSTResponseBody) other);
